...
class AboutResource @JvmOverloads constructor(@get:GET
                                              @get:Timed
                                              @get:ApiOperation(value = "Get some info about the server", response = AppInfo::class) val about: AppInfo = AppInfo())
